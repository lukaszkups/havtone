export default function havtone(opts) {
    const { canvasId, size = 10, minSize = 5, spacing = 15, image, rotation = 0, maxFPS = 60, shape = 'square', hoverEffect = false, hoverSize = 200, animate = true, randomizedSize = false, sensitivity = 5, hoverSizeMultiplier = 2, animationStepMultiplier = 0.5, } = opts;
